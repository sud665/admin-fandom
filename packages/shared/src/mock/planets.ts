...
export const mockPlanets: Planet[] = [
  ...
  { id: 'stray-kids', name: 'Stray Kids', artistId: 'artist-skz', fpi: 58, totalPop: 650_000, orbitIndex: 3, color: '#FF6B35', isEclipsed: true, eclipseStartedAt: new Date(Date.now() - 30 * 60 * 1000), eclipseEndsAt: new Date(Date.now() + 30 * 60 * 1000) },
